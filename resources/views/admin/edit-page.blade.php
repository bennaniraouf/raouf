        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6 col-lg-12">
              <!-- Donors edit information -->
                
                <div class="card p-5">
                    <div class="text-capitalize text-center fs-2 ">edit informations</div>
                    @if(session('status'))
                      <div class="alert alert-success" role="alert">
                          {{session('status')}}
                      </div>
                    @endif
                    <form action="/update-info/{{$data->id}}" method="POST" class="d-flex justify-content-center flex-column">
                        @csrf
                        {{ method_field('PUT')}}
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary col-2 mb-3 mt-3">Submit</button>
                            <a href="/tables-data" class="btn btn-danger col-2">cancel</a>
                        </div>
