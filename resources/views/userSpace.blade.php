...
<head>
  ...
  <link href="{{URL::to('/')}}/import/assets/img/logos/logo1.png" rel="icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{URL::to('/')}}/import/assets/img/logos/logo1.png" alt="">
        <span class="d-none d-lg-block ">{{Session::get('user')['familyname']}}</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <span class="d-none d-md-block dropdown-toggle ps-2">MR.{{Session::get('user')['familyname']}}</span>
          </a><!-- End Profile -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6 class="text-capitalize">{{Session::get('user')['familyname']}}</h6>
            </li>
            <li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="/userSpace">
        ...
        <nav class="nav-links">
            <ul class="fs-4 ps-0 mb-3">
                ...
                <li class="mb-3">
                 ...
                 <li class="mb-3">
                    <a class="dropdown-item d-flex align-items-center fs-4" href="/logout">
      ...
      <div class="row">
        ...
        <div class="col-xl-8">
          ...
          <div class="card">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{Session::get('user')['familyname']}}</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Country</div>
                    <div class="col-lg-9 col-md-8">Algeria</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Address</div>
                    <div class="col-lg-9 col-md-8">{{Session::get('user')['adress']}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">{{Session::get('user')['phonenumber']}}</div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{Session::get('user')['image']}}" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="{{Session::get('user')['name']}}}}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="{{Session::get('user')['email']}}">
                      </div>
                    </div>
            ...
            <div class="col-md-2 " style="color:#DC143C;">
                <div class="text-center"><h2 class="c text-capitalize">history</h2></div>
